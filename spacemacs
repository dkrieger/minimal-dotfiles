...
you should place your code here."
  ...
  ;; ;; reduce example w/ append
  ;; (print (seq-reduce (lambda (carry el) (append carry (list el))) '(1 2 3 4) '(-1 0)))

  ;;;;* light configuration

  ;; (spacemacs/set-leader-keys "tr" '()) ; custom leaders
  (setq-default evil-escape-key-sequence "jk")
  (setq-default spacemacs-indent-sensitive-modes '(coffee-mode elm-mode haml-mode
                                                  haskell-mode slim-mode
                                                  makefile-mode
  ...
  ;;;;** search includes hidden content
  (setq-default search-invisible t) ; https://github.com/syl20bnr/spacemacs/issues/3623

  ;;;;** (native) relative line numbers
  (setq-default display-line-numbers 'visual)

  ;;;;** dired clever default directory
  (setq-default dired-dwim-target t)

  ;;;;** transparent frames by default
...
(custom-set-variables
 ...
 '(eshell-visual-commands
   (quote
    ("vi" "screen" "top" "less" "more" "lynx" "ncftp" "pine" "tin" "trn" "elm" "fzf")))
 '(evil-want-Y-yank-to-eol nil)
 '(org-agenda-files
   (quote
    ("~/org/projects/taxes.org" "~/org/agendas/work.org" "~/org/agendas/misc.org" "~/org/agendas/home.org")) t)
 '(org-capture-templates
   (quote
    (("j" "Journal Entry" entry
      ...
      "* %?
CREATED: %U
SRC: %a" :jump-to-captured t :empty-lines 1)
     ("t" "TODO" entry
...
SRC: %a"))))
 '(package-selected-packages
   (quote
    (kubernetes-tramp kubernetes-evil kubernetes rvm ruby-tools ruby-test-mode rubocop rspec-mode robe rbenv rake minitest chruby bundler inf-ruby pdf-tools auctex-latexmk auctex yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional helm-pydoc cython-mode anaconda-mode pythonic phpunit phpcbf php-extras php-auto-yasnippets yasnippet drupal-mode php-mode dockerfile-mode docker json-mode tablist docker-tramp json-snatcher json-reformat yaml-mode mmm-mode markdown-toc markdown-mode gh-md web-mode tagedit slim-mode scss-mode sass-mode pug-mode helm-css-scss haml-mode emmet-mode smeargle orgit magit-gitflow magit-popup helm-gitignore gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link evil-magit magit transient git-commit with-editor org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-mime org-download htmlize gnuplot ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async)))
